...
setDestination(data)
 ...
 const handleDate = (startDate, endDate) => {
  setCheckin(startDate
    ...
    : null)
setCheckout(endDate ? endDate.toLocaleDateString("en-US", { weekday: "short", day: "numeric", month: "short"}) : null)
 }
...
<svg viewBox="0 0 24 24" width="24" height="24"><path fill='#767676' d="M16.32 14.906l5.387 5.387a1 1 0 01-1.414 1.414l-5.387-5.387a8 8 0 111.414-1.414zM10 16a6 6 0 100-12 6 6 0 000 12z"></path></svg>
            ...
            <Stack direction="column" sx={{}}>
              {destination != "" ? (<>
              <Typography sx={{ color: "#767676", fontSize: "12px", lineHeight: "16px", }}>Destination</Typography>
              <Typography sx={{ color: "#1d1d1d", fontSize: "14px", lineHeight: "16px", fontWeight: "600" }}>Makkah, Saudia Arabia</Typography>
              </>
              )
          ...
          <Box sx={{display:"flex"}}>
            <Box onClick={()=> setCalenderOpen(true)} sx={{
                      ...
                      <Stack direction="column">
                        <Typography sx={{ color: "#767676", fontSize: "12px", lineHeight: "16px", }}>Check-in Date</Typography>
                        <Typography sx={{ color: "#1d1d1d", fontSize: "14px", lineHeight: "16px", fontWeight: "600" }}>
                        {checkin}
          </Typography>            </Stack>
          
                    </Box>
              
                              <Box  sx={{width:"45%", minHeight:"62px", padding:"12px 16px", borderLeft:"1px solid #f4f4f4"}}>
                                <Stack direction="column" height="100%" justifyContent="center">
                                              <Typography sx={{ color: "#767676", fontSize: "12px", lineHeight: "16px", }}>Check-out Date</Typography>
                                              <Typography sx={{ color: "#1d1d1d", fontSize: "14px", lineHeight: "16px", fontWeight: "600" }}>
                                              {checkout}
                                              </Typography>
                                              </Stack>
          ...
          <Box onClick={()=> setOpenDrawer(true)} sx={{
                      ...
                      <Stack direction="column" sx={{}}>
                        <Typography sx={{ color: "#767676", fontSize: "12px", lineHeight: "16px", }}>Guests & Rooms</Typography>
                        <Typography sx={{ color: "#1d1d1d", fontSize: "14px", lineHeight: "16px", fontWeight: "600" }}>{text}
                        </Typography>
                      </Stack>
    ...
    <Button fullWidth variant="contained" sx={{ mt: 2,px:2, borderRadius: "100px", textTransform: "none", bgcolor: "#44b50c", color: "white", fontSize: "16px", fontWeight: "600px", p: "10px 24px" }}>
          ...
          {/* menus */}
          {/* location drawer */}
          <LocationDrawer locations={locations} open={location} setOpen={setLocation} showBtn={false} setData={setDestination} handleData={showData} />
          {/* calender drawer */}
